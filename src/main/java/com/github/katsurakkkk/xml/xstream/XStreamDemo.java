...
public class XStreamDemo {
    ...
    public static Persons getPersons() {
        ...
        Person person1 = new Person(null, null, "lavasoft", "man");
        ...
        persons.setXmlns("szfs.tws.info.contractchange");
        persons.setXmlnsxsi("http://www.w3.org/2001/XMLSchema-instance");
        return persons;
    }
